...
complete -c sg_format -s F -l format -d 'issue a SCSI FORMAT UNIT command'
...
complete -c sg_format -s m -l timeout -d 'where SECS is the FORMAT UNIT or FORMAT MEDIUM command timeout in seconds'
