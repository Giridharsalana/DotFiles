...
complete -c cryptsetup -l persistent -d 'If used with LUKS2 devices and activation commands like open, the specified a…'
...
complete -c cryptsetup -l unbound -d 'Creates new LUKS2 unbound keyslot.  See luksAddKey action for more details'
